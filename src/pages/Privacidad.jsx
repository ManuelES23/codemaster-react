        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              En CodeMaster nos comprometemos a proteger tu privacidad y tus datos personales
            </p>
          </motion.div>
        </div>
      </motion.section>
        ...
        <div className="max-w-4xl mx-auto">
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-300">
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li><strong>Información de contacto:</strong> Nombre, correo electrónico, número de teléfono y empresa cuando nos contactas a través de nuestros formularios.</li>
                    <li><strong>Información técnica:</strong> Dirección IP, tipo de navegador, sistema operativo, páginas visitadas y tiempo de navegación.</li>
                    <li><strong>Cookies:</strong> Utilizamos cookies para mejorar tu experiencia en nuestro sitio web.</li>
                    <li><strong>Información de proyectos:</strong> Detalles sobre los servicios solicitados y requisitos específicos de tu proyecto.</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          >
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                <h2 className="text-2xl font-bold mb-4">2. Cómo Utilizamos tu Información</h2>
                <div className="space-y-4 text-gray-300">
                  <p>Utilizamos la información recopilada para:</p>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>Responder a tus consultas y solicitudes de servicios</li>
                    <li>Proporcionar cotizaciones y propuestas personalizadas</li>
                    ...
                    <li>Analizar el uso de nuestro sitio web para optimizar su rendimiento</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          >
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                <h2 className="text-2xl font-bold mb-4">3. Protección de tus Datos</h2>
                <div className="space-y-4 text-gray-300">
          ...
          >
            ...
            <div className="space-y-4 text-gray-300">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li><strong>Proveedores de servicios:</strong> Compartimos información con proveedores que nos ayudan a operar nuestro negocio (hosting, procesamiento de pagos, análisis).</li>
                <li><strong>Requisitos legales:</strong> Podemos divulgar información cuando sea requerido por ley o para proteger nuestros derechos.</li>
                <li><strong>Transferencia de negocio:</strong> En caso de fusión, adquisición o venta de activos, tu información puede ser transferida.</li>
              </ul>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-2xl p-8 mb-8"
          >
            <h2 className="text-2xl font-bold mb-4">5. Tus Derechos (LFPDPPP - México)</h2>
            <div className="space-y-4 text-gray-300">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li><strong>Acceso (ARCO):</strong> Conocer qué datos personales tenemos sobre ti</li>
                ...
                <li><strong>Limitación de uso:</strong> Solicitar que limitemos el uso de tus datos</li>
              </ul>
              <p className="mt-4">Para ejercer estos derechos, contáctanos en: <a href="mailto:manuel@codemaster.com.mx" className="text-orange-500 hover:text-orange-400">manuel@codemaster.com.mx</a></p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-4 text-gray-300">
              <p>Utilizamos cookies y tecnologías similares para mejorar tu experiencia. Para más información, consulta nuestra <a href="/cookies" className="text-orange-500 hover:text-orange-400">Política de Cookies</a>.</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-4 text-gray-300">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>Cumplir con obligaciones legales y fiscales (mínimo 5 años según legislación mexicana)</li>
                <li>Resolver disputas y hacer cumplir nuestros acuerdos</li>
              </ul>
              <p className="mt-4">Una vez que los datos ya no sean necesarios, serán eliminados o anonimizados de forma segura.</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-4 text-gray-300">
              <p>Nuestros servicios no están dirigidos a menores de 18 años. No recopilamos intencionalmente información personal de menores. Si eres padre o tutor y crees que tu hijo nos ha proporcionado información personal, contáctanos para eliminarla.</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-4 text-gray-300">
              <p>Si tienes preguntas sobre esta Política de Privacidad o deseas ejercer tus derechos ARCO, contáctanos:</p>
